...
local AnimationNode = require "engine.3DRenderer.model.animation.modelAnimationNode"
local Animator = require "engine.3DRenderer.model.animation.modelAnimator"
